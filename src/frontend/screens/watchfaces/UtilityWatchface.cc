...
UtilityWatchface::UtilityWatchface(BackendInterface *backend, ScreenManager *screenManager, Settings *settings)
    ...
    lv_obj_align(_dayOfWeekLabel, nullptr, LV_ALIGN_CENTER, 32, 2);
    ...
    lv_obj_align(_dayOfMonthLabel, nullptr, LV_ALIGN_CENTER, 62, 2);
...
void UtilityWatchface::timeChanged(bool hourChanged, bool minuteChanged, bool secondChanged) {
    (void)secondChanged;
...
const char *UtilityWatchface::dayOfWeekText() {
    char const* weekDays[] = { "SU", "MO", "TU", "WE", "TH", "FR", "SA" };
