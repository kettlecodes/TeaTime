...
public:
    ...
    UtilityWatchface(BackendInterface *backend, ScreenManager *screenManager, Settings *settings);

protected:

    ScreenManager::ScreenId screenId() const override { return ScreenManager::ScreenId::UtilityWatchface; }
