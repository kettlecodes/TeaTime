...
FirmwareValidationScreen::FirmwareValidationScreen(BackendInterface *backend, ScreenManager *screenManager, Settings *settings)
    ...
    if (this->backend()->firmwareValidation()->isValidated()) {
...
void FirmwareValidationScreen::handleButtonClick() {
    ...
    if (this->backend()->firmwareValidation()->isValidated()) {
        // reset
        this->backend()->firmwareValidation()->reset();
        ...
        // validate
        this->backend()->firmwareValidation()->validate();
